...
export default function About() {
    return (
        <div className="flex min-h-screen ">
            <h1 className="text-5xl font-bold mt-44 ml-[496px] text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-red-500">Hassan <span className="text-transparent bg-clip-text bg-gradient-to-r from-fuchsia-600 to-red-700">Azhar</span>
            </h1>
