...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="flex justify-between items-center p-4 bg-transparent">
      <h1 className="relative text-4xl sm:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 animate-gradientFlow ml-4">
      ...
      <div className="hidden md:flex space-x-8">
        ...
        <Link
          href="/testimonial"
          className={`${menuOpen === "Testimonial"
              ? "text-2xl text-green-500 underline underline-offset-8"
              : "text-white hover:text-green-300"
            } font-medium`}
  ...
  <Link
    ...
    download
    target={"_blank"}
    className="hidden md:block bg-gray-700 text-white py-2 px-4 rounded-md hover:bg-gray-600 mr-4"
  >
