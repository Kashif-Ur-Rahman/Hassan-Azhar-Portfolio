    ...
    <footer className="bg-gray-900 text-gray-300 py-8 mt-8">
      <div className="container mx-auto text-center flex flex-col lg:flex-row items-center justify-between">
        ...
        <div className="flex flex-wrap justify-center gap-6 text-xl font-medium mb-4 lg:mb-0">
          ...
          <a className="transition hover:text-teal-500 dark:hover:text-teal-400" href="/project">
            Project
          </a>
          <a className="transition hover:text-teal-500 dark:hover:text-teal-400" href="/testimonial">
            Testimonial
          </a>
        ...
        <p className="text-xl text-center">
          © {new Date().getFullYear()} Hassan Azhar. All rights reserved.
        </p>
      </div>
    </footer>
  );
